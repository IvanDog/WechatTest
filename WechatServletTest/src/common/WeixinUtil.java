...
public class WeixinUtil {
    ...
    //主动推送信息接口(群发) 限1（次/天）
    private String send_msg_url = "https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=ACCESS_TOKEN";
     ...
     * @param accessToken 有效的access_token
     */
    public int sendMessage(String accessToken,String msg){
            int result = 0;
            // 拼装创建菜单的url
